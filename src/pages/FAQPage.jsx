...
const FAQ_ITEMS = [
  {
    category: "الخصومات والعروض",
    questions: [
      {
        q: "ما هي الخصومات المتاحة؟",
        a: "خصم لكل طفل إضافي! بالإضافة لعروض موسمية — تابعنا للاطلاع على أحدث العروض والنسب.",
      },
      {
        q: "هل يمكن الطلب لعدد كبير من الأطفال أو لجمعية خيرية؟",
        a: "نعم! تواصل مع الإدارة مباشرة وسنوفر لك عرض خاص يناسب احتياجك.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "كيف أطلب اللعبة؟",
        a: "اضغط على 'اطلب الآن' واملأ نموذج الطلب ببياناتك وبيانات الأطفال. بعد الإرسال سنتواصل معك عبر الواتساب لإتمام الدفع.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "4 مواد: الرياضيات، اللغة العربية، اللغة الإنجليزية، والعلوم. الأسئلة مصممة للمراحل من الروضة حتى السادس ابتدائي.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "نعم! عند تعبئة نموذج الطلب، فعّل خيار كارت الهدية لكل طفل واختر التصميم المناسب. سنجهز كرت هدية مخصص مع الروابط.",
      },
    ],
  },
];
